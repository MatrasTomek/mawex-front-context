...
const BannerSlider = () => {
	const BANNER_SLIDER = [
		...
		{
			id: 2,
			content: 'Księgowość dla transportu',
			imgPathSmall: 'images/banner/finance-7529921_640.jpg',
			imgPathBig: 'images/banner/finance-7529921_1920.jpg',
			urlPath: '/ksiegowosc',
		},
		{
			id: 3,
			content: 'Serwis, legalizacja tachografów',
			imgPathSmall: 'images/banner/electric-948208_640.jpg',
			imgPathBig: 'images/banner/electric-948208_1920.jpg',
			urlPath: '/tachografy',
		},
		{
			id: 4,
	...
	return (
		<div className={styles.wrapper}>
			...
			<div className={styles.links}>
				<Link id={BANNER_SLIDER[picIndex].urlPath} onClick={handleSwithLogo} to={`${BANNER_SLIDER[picIndex].urlPath}`}>
					Zobacz
				</Link>
			</div>
