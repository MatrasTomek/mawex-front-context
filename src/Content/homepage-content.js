export const firstSection = {
	bigTitle: "Z NAMI JESTEŚ NA DOBREJ DRODZE!",
	title1: "Ewidencja czasu pracy kierowców – MAWEX",
	content1:
		"Firma MAWEX oferuje kompleksowe usługi w zakresie prowadzenia ewidencji czasu pracy kierowców. Zapewniamy wsparcie przedsiębiorcom, przejmując obowiązek wykonywania szczegółowej analizy czasu pracy kierowcy, rozliczania czasu pracy kierowcy, oceny ryzyka wystąpienia naruszeń oraz sprawdzania ciągłości zapisów aktywności kierowców. Korzyścią z podjęcia współpracy jest przede wszystkim rzetelnie przygotowana ewidencja czasu pracy kierowcy, dokładnie wyliczone delegacje krajowe i zagraniczne, nadzorowanie terminowego pobierania danych z tachografów cyfrowych i kart kierowców oraz weryfikację ciągłości zapisów aktywności kierowców co przekłada się dla przedsiębiorcy na oszczędność czasu oraz kosztów. Dodatkowo zapewniamy naszym klientom wstępny audyt dokumentacji, okresowe szkolenia kierowców a także pomoc w zarządzaniu środkami transportu.",
	title2: "Prawo a ewidencja czasu pracy kierowcy",
	content2:
		"Częsta zmienność przepisów dotyczących czasu pracy kierowcy stanowi poważne utrudnienie dla przedsiębiorców. Samodzielne analizowanie wykresówek czy danych z kart kierowcy bywa czasochłonne i wiąże się z koniecznością posiadania aktualnej wiedzy na temat przepisów prawnych regulujących sposób analizy i rozliczenia czasu pracy kierowców. Brak prowadzenia ewidencji czasu pracy kierowcy lub nieprawidłowości w dokumentach mogą wiązać się z konsekwencjami w postaci kary grzywny. Klienci, którzy z nami współpracują, otrzymują profesjonalnie wykonane raporty i dokumentację, które przygotowano na podstawie aktualnie obowiązujących przepisów. Wciąż doskonalimy swoje umiejętności w celu zaspokojenia potrzeb naszych klientów. Nieustannie śledzimy zmieniające się taryfikatory, ustawy i rozporządzenia wydawane w Polsce i Unii Europejskiej.",
	title3: "Posługujemy się najlepszymi narzędziami",
	content3:
		"Znajomość prawa wykorzystujemy do szkolenia kierowców. Aktualna wiedza oraz świadomość obowiązków pozwala zminimalizować ilość popełnianych naruszeń w pracy kierowców i zredukować koszty, które są z nimi związane. Działamy na najlepszym dostępnym na rynku oprogramowaniu 4Trans. Program jest rekomendowany przez Inspekcję Transportu Drogowego i Państwową Inspekcję Pracy oraz na bieżąco aktualizowany o wszelkie zmiany prawne w Polsce i UE. System umożliwia kontrolę i analizę czasu pracy kierowcy, a także weryfikację manipulacji tachografów cyfrowych. Zlecenie nam ewidencji czasu pracy kierowców zatrudnionych w Państwa firmie to doskonały sposób na oszczędności. Przedsiębiorcy nie tylko nie muszą opłacać dostępu do oprogramowania, ale również zatrudniać i szkolić pracownika lub pracowników, którzy byliby odpowiedzialni za wykonywanie czynności związanych z nadzorem nad pracą kierowców.",
};
